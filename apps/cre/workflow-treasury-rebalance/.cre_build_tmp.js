...
var addr = exports_external.string().regex(/^0x[a-fA-F0-9]{40}$/u);
var configSchema = exports_external.object({
  ...
  bufferTargetBPS: exports_external.string().regex(/^\d+$/),
  bufferUpperBPS: exports_external.string().regex(/^\d+$/),
  bufferLowerBPS: exports_external.string().regex(/^\d+$/)
});
...
var file_capabilities_blockchain_evm_v1alpha_client = /* @__PURE__ */ fileDesc2("", [file_sdk_v1alpha_sdk2, file_tools_generator_v1alpha_cre_metadata2, file_values_v1_values2]);
var FilterLogTriggerRequestSchema2 = /* @__PURE__ */ messageDesc2(file_capabilities_blockchain_evm_v1alpha_client, 1);
var CallContractRequestSchema2 = /* @__PURE__ */ messageDesc2(file_capabilities_blockchain_evm_v1alpha_client, 2);
var CallContractReplySchema2 = /* @__PURE__ */ messageDesc2(file_capabilities_blockchain_evm_v1alpha_client, 3);
var FilterLogsRequestSchema2 = /* @__PURE__ */ messageDesc2(file_capabilities_blockchain_evm_v1alpha_client, 4);
var FilterLogsReplySchema2 = /* @__PURE__ */ messageDesc2(file_capabilities_blockchain_evm_v1alpha_client, 5);
var LogSchema2 = /* @__PURE__ */ messageDesc2(file_capabilities_blockchain_evm_v1alpha_client, 6);
var BalanceAtRequestSchema2 = /* @__PURE__ */ messageDesc2(file_capabilities_blockchain_evm_v1alpha_client, 10);
var BalanceAtReplySchema2 = /* @__PURE__ */ messageDesc2(file_capabilities_blockchain_evm_v1alpha_client, 11);
var EstimateGasRequestSchema2 = /* @__PURE__ */ messageDesc2(file_capabilities_blockchain_evm_v1alpha_client, 12);
var EstimateGasReplySchema2 = /* @__PURE__ */ messageDesc2(file_capabilities_blockchain_evm_v1alpha_client, 13);
var GetTransactionByHashRequestSchema2 = /* @__PURE__ */ messageDesc2(file_capabilities_blockchain_evm_v1alpha_client, 14);
var GetTransactionByHashReplySchema2 = /* @__PURE__ */ messageDesc2(file_capabilities_blockchain_evm_v1alpha_client, 15);
var GetTransactionReceiptRequestSchema2 = /* @__PURE__ */ messageDesc2(file_capabilities_blockchain_evm_v1alpha_client, 17);
var GetTransactionReceiptReplySchema2 = /* @__PURE__ */ messageDesc2(file_capabilities_blockchain_evm_v1alpha_client, 18);
var HeaderByNumberRequestSchema2 = /* @__PURE__ */ messageDesc2(file_capabilities_blockchain_evm_v1alpha_client, 20);
var HeaderByNumberReplySchema2 = /* @__PURE__ */ messageDesc2(file_capabilities_blockchain_evm_v1alpha_client, 21);
var WriteReportRequestSchema2 = /* @__PURE__ */ messageDesc2(file_capabilities_blockchain_evm_v1alpha_client, 23);
var GasConfigSchema2 = /* @__PURE__ */ messageDesc2(file_capabilities_blockchain_evm_v1alpha_client, 24);
var WriteReportReplySchema2 = /* @__PURE__ */ messageDesc2(file_capabilities_blockchain_evm_v1alpha_client, 25);
...
var hexToBytes3 = (hexStr) => {
  ...
  for (let i2 = 0;i2 < hex.length; i2 += 2) {
    bytes[i2 / 2] = Number.parseInt(hex.slice(i2, i2 + 2), 16);
  }
  return bytes;
};
...
class ClientCapability4 {
  ...
  callContract(runtime2, input) {
    ...
    const capabilityId = `${ClientCapability4.CAPABILITY_NAME}:ChainSelector:${this.ChainSelector}@${ClientCapability4.CAPABILITY_VERSION}`;
...
class ClientLogTrigger {
  ...
  constructor(config, _capabilityId, _method, ChainSelector) {
    ...
    this.ChainSelector = ChainSelector;
    this.config = config.$typeName ? config : fromJson2(FilterLogTriggerRequestSchema2, config);
  }
  capabilityId() {
...
var file_capabilities_networking_http_v1alpha_client2 = /* @__PURE__ */ fileDesc2("", [file_google_protobuf_duration2, file_tools_generator_v1alpha_cre_metadata2]);
...
var ConfigSchema4 = /* @__PURE__ */ messageDesc2(file_capabilities_scheduler_cron_v1_trigger, 0);
var PayloadSchema4 = /* @__PURE__ */ messageDesc2(file_capabilities_scheduler_cron_v1_trigger, 1);
...
class CronTrigger {
  ...
  constructor(config, _capabilityId, _method) {
    this._capabilityId = _capabilityId;
    this._method = _method;
    this.config = config.$typeName ? config : fromJson2(ConfigSchema4, config);
  }
  capabilityId() {
    return this._capabilityId;
  }
...
var getNetwork = (options) => defaultLookup2.find(options);
...
class Int642 {
  ...
  div(i2, safe = true) {
    return new Int642(this.value / i2.value);
  }
}
...
class UInt642 {
  ...
  div(i2, safe = true) {
    return new UInt642(this.value / i2.value);
  }
}
...
function withCron(callback, getSchedule) {
  return (config) => {
    const schedule = getSchedule ? getSchedule(config) : config["schedule"];
    ...
    return handler2(new CronCapability2().trigger({ schedule }), callback);
  };
}
...
class UnknownTypeError2 extends BaseError2 {
  constructor({ type }) {
    super("Unknown type.", {
      metaMessages: [
...
class InvalidAbiParametersError2 extends BaseError2 {
  constructor({ params }) {
...
class InvalidParameterError2 extends BaseError2 {
  constructor({ param }) {
...
class SolidityProtectedKeywordError2 extends BaseError2 {
...
class InvalidModifierError2 extends BaseError2 {
...
class InvalidFunctionModifierError2 extends BaseError2 {
  constructor({ param, type, modifier }) {
    super("Invalid ABI parameter.", {
      details: param,
      metaMessages: [
...
class InvalidAbiTypeParameterError2 extends BaseError2 {
...
class InvalidSignatureError2 extends BaseError2 {
...
class InvalidStructSignatureError2 extends BaseError2 {
...
class CircularReferenceError2 extends BaseError2 {
  constructor({ type }) {
...
class InvalidParenthesisError2 extends BaseError2 {
...
function isHex2(value3, { strict = true } = {}) {
  if (!value3)
    return false;
...
function size2(value3) {
  if (isHex2(value3, { strict: false }))
...
class AbiDecodingDataSizeTooSmallError2 extends BaseError4 {
...
class AbiDecodingZeroDataError2 extends BaseError4 {
  constructor() {
...
class AbiEncodingBytesSizeMismatchError2 extends BaseError4 {
  constructor({ expectedSize, value: value3 }) {
    super(`Size of bytes "${value3}" (bytes${size2(value3)}) does not match expected size (bytes${expectedSize}).`, { name: "AbiEncodingBytesSizeMismatchError" });
  }
}
...
class AbiFunctionNotFoundError2 extends BaseError4 {
...
class AbiFunctionOutputsNotFoundError2 extends BaseError4 {
  constructor(functionName, { docsPath }) {
    super([
...
class AbiItemAmbiguityError extends BaseError4 {
  constructor(x, y) {
...
class InvalidAbiDecodingTypeError2 extends BaseError4 {
  constructor(type, { docsPath }) {
    super([
...
class InvalidArrayError2 extends BaseError4 {
  constructor(value3) {
...
class InvalidDefinitionTypeError2 extends BaseError4 {
  constructor(type) {
    super([
...
class InvalidAddressError2 extends BaseError4 {
  constructor({ address }) {
...
class SliceOffsetOutOfBoundsError2 extends BaseError4 {
...
class SizeExceedsPaddingSizeError2 extends BaseError4 {
...
class IntegerOutOfRangeError2 extends BaseError4 {
  constructor({ max, min, signed, size: size3, value: value3 }) {
    super(`Number "${value3}" is not in safe ${size3 ? `${size3 * 8}-bit ${signed ? "signed" : "unsigned"} ` : ""}integer range ${max ? `(${min} to ${max})` : `(above ${min})`}`, { name: "IntegerOutOfRangeError" });
  }
}

class InvalidBytesBooleanError2 extends BaseError4 {
  constructor(bytes) {
...
class SizeOverflowError2 extends BaseError4 {
...
function hexToBigInt2(hex, opts = {}) {
  ...
  if (value3 <= max)
    return value3;
  return value3 - BigInt(`0x${"f".padStart(size3 * 2, "f")}`) - 1n;
}
function hexToNumber2(hex, opts = {}) {
  const value3 = hexToBigInt2(hex, opts);
...
function toHex2(value3, opts = {}) {
  if (typeof value3 === "number" || typeof value3 === "bigint")
    return numberToHex2(value3, opts);
  if (typeof value3 === "string") {
    return stringToHex2(value3, opts);
  }
  if (typeof value3 === "boolean")
    return boolToHex2(value3, opts);
  return bytesToHex3(value3, opts);
}
function boolToHex2(value3, opts = {}) {
...
function bytesToHex3(value3, opts = {}) {
  let string = "";
  for (let i2 = 0;i2 < value3.length; i2++) {
    string += hexes[value3[i2]];
  }
  const hex = `0x${string}`;
  if (typeof opts.size === "number") {
    assertSize2(hex, { size: opts.size });
...
function numberToHex2(value_, opts = {}) {
  ...
  const hex = `0x${(signed && value3 < 0 ? (1n << BigInt(size3 * 8)) + BigInt(value3) : value3).toString(16)}`;
  if (size3)
...
function toBytes2(value3, opts = {}) {
  if (typeof value3 === "number" || typeof value3 === "bigint")
    return numberToBytes2(value3, opts);
  if (typeof value3 === "boolean")
    return boolToBytes2(value3, opts);
  if (isHex2(value3))
    return hexToBytes4(value3, opts);
  return stringToBytes2(value3, opts);
}
function boolToBytes2(value3, opts = {}) {
...
function numberToBytes2(value3, opts) {
  const hex = numberToHex2(value3, opts);
  return hexToBytes4(hex);
}
function stringToBytes2(value3, opts = {}) {
...
function keccak2562(value3, to_) {
  const to = to_ || "hex";
  const bytes = keccak_256(isHex2(value3, { strict: false }) ? toBytes2(value3) : value3);
  if (to === "bytes")
    return bytes;
  return toHex2(bytes);
}
...
var staticCursor = {
  ...
  pushUint8(value3) {
    this.assertPosition(this.position);
    this.bytes[this.position] = value3;
    this.position++;
  },
  pushUint16(value3) {
    this.assertPosition(this.position + 1);
    this.dataView.setUint16(this.position, value3);
    this.position += 2;
  },
  pushUint24(value3) {
    this.assertPosition(this.position + 2);
    this.dataView.setUint16(this.position, value3 >> 8);
    this.dataView.setUint8(this.position + 2, value3 & ~4294967040);
    this.position += 3;
  },
  pushUint32(value3) {
    this.assertPosition(this.position + 3);
    this.dataView.setUint32(this.position, value3);
    this.position += 4;
  },
  readByte() {
    this.assertReadLimit();
    this._touch();
    const value3 = this.inspectByte();
    this.position++;
    return value3;
  },
  readBytes(length, size3) {
    this.assertReadLimit();
    this._touch();
    const value3 = this.inspectBytes(length);
  ...
  readUint8() {
    this.assertReadLimit();
    this._touch();
    const value3 = this.inspectUint8();
    this.position += 1;
    return value3;
  },
  readUint16() {
    this.assertReadLimit();
    this._touch();
    const value3 = this.inspectUint16();
    this.position += 2;
    return value3;
  },
  readUint24() {
    this.assertReadLimit();
    this._touch();
    const value3 = this.inspectUint24();
    this.position += 3;
    return value3;
  },
  readUint32() {
    this.assertReadLimit();
    this._touch();
    const value3 = this.inspectUint32();
    this.position += 4;
    return value3;
  },
  get remaining() {
...
function slice2(value3, start, end, { strict } = {}) {
  if (isHex2(value3, { strict: false }))
    return sliceHex2(value3, start, end, {
      strict
    });
  return sliceBytes2(value3, start, end, {
    strict
  });
}
function assertStartOffset(value3, start) {
  if (typeof start === "number" && start > 0 && start > size2(value3) - 1)
...
function assertEndOffset(value3, start, end) {
  if (typeof start === "number" && typeof end === "number" && size2(value3) !== end - start) {
    throw new SliceOffsetOutOfBoundsError2({
      offset: end,
      position: "end",
      size: size2(value3)
...
function encodeAddress(value3) {
  if (!isAddress2(value3))
    throw new InvalidAddressError2({ address: value3 });
  return { dynamic: false, encoded: padHex2(value3.toLowerCase()) };
}
function encodeArray(value3, { length, param }) {
  const dynamic = length === null;
  if (!Array.isArray(value3))
    throw new InvalidArrayError2(value3);
  ...
  const preparedParams = [];
  for (let i2 = 0;i2 < value3.length; i2++) {
    const preparedParam = prepareParam({ param, value: value3[i2] });
...
function encodeBytes(value3, { param }) {
  ...
  return { dynamic: false, encoded: padHex2(value3, { dir: "right" }) };
}
function encodeBool(value3) {
  if (typeof value3 !== "boolean")
    throw new BaseError4(`Invalid boolean value: "${value3}" (type: ${typeof value3}). Expected: \`true\` or \`false\`.`);
  return { dynamic: false, encoded: padHex2(boolToHex2(value3)) };
}
function encodeNumber(value3, { signed, size: size3 = 256 }) {
...
function encodeString(value3) {
  const hexValue = stringToHex2(value3);
  const partsLength = Math.ceil(size2(hexValue) / 32);
  const parts = [];
  for (let i2 = 0;i2 < partsLength; i2++) {
    parts.push(padHex2(slice2(hexValue, i2 * 32, (i2 + 1) * 32), {
      dir: "right"
    }));
  }
  return {
...
function encodeTuple(value3, { param }) {
  ...
  for (let i2 = 0;i2 < param.components.length; i2++) {
    ...
    const index = Array.isArray(value3) ? i2 : param_.name;
...
function decodeAddress(cursor) {
  ...
  return [checksumAddress2(bytesToHex3(sliceBytes2(value3, -20))), 32];
}
...
function decodeBytes(cursor, param, { staticPosition }) {
  ...
  const value3 = bytesToHex3(cursor.readBytes(Number.parseInt(size3, 10), 32));
  return [value3, 32];
}
function decodeNumber(cursor, param) {
  ...
  const value3 = cursor.readBytes(32);
  return [
    size3 > 48 ? bytesToBigInt2(value3, { signed }) : bytesToNumber2(value3, { signed }),
    32
  ];
}
function decodeTuple(cursor, param, { staticPosition }) {
  const hasUnnamedChild = param.components.length === 0 || param.components.some(({ name }) => !name);
  const value3 = hasUnnamedChild ? [] : {};
  let consumed = 0;
  if (hasDynamicChild(param)) {
    const offset = bytesToNumber2(cursor.readBytes(sizeOfOffset));
    const start = staticPosition + offset;
    for (let i2 = 0;i2 < param.components.length; ++i2) {
      ...
      consumed += consumed_;
      value3[hasUnnamedChild ? i2 : component?.name] = data;
    }
    cursor.setPosition(staticPosition + 32);
    return [value3, 32];
  }
...
function decodeString(cursor, { staticPosition }) {
  ...
  const value3 = bytesToString2(trim2(data));
  cursor.setPosition(staticPosition + 32);
  return [value3, 32];
}
...
var hash = (value3) => keccak2562(toBytes2(value3));
...
function publishAttestation(runtime3, attestation) {
  ...
  const dataHash = keccak2562(toHex2(JSON.stringify(attestation.data)));
  const timestamp = Math.floor(Date.now() / 1000);
  runtime3.log(`Publishing attestation: type=${attestation.type} entity=${attestation.entityId}`);
  const reportData = encodeAbiParameters2(parseAbiParameters2("uint8 opType, string entityId, bytes32 dataHash, uint256 timestamp, string metadata"), [
    opType,
  ...
  const evmClient = new ClientCapability4(network495.chainSelector.selector);
  ...
  const txHash = bytesToHex2(writeResult.txHash ?? new Uint8Array(32));
  const attestationId = keccak2562(toHex2(`${opType}${attestation.entityId}${timestamp}`));
...
function resolveEvmClient(config, isTestnet = true) {
  const network495 = getNetwork({
    chainFamily: "evm",
  ...
  if (!network495) {
    throw new Error(`resolveEvmClient: Network not found for chain selector: ${config.chainSelectorName}`);
  }
  return new ClientCapability4(network495.chainSelector.selector);
}
function callView(runtime3, contractAddress, abi, functionName, args) {
  const evmClient = resolveEvmClient(runtime3.config);
  ...
  return decodeFunctionResult2({
    abi,
    functionName,
    data: bytesToHex2(contractCall.data)
  });
}
var TREASURY_MANAGER_ABI = [
...
var treasuryRebalanceCheck = withCron((runtime3) => {
  runtime3.log("Treasury rebalance check starting");
  const bufferRatioBPS = callView(runtime3, runtime3.config.treasuryManagerAddress, TREASURY_MANAGER_ABI, "getBufferRatioBPS");
  const usdcBuffer = callView(runtime3, runtime3.config.usdcAddress, ERC20_ABI, "balanceOf", [runtime3.config.usdcgAddress]);
  const yieldValue = callView(runtime3, runtime3.config.treasuryManagerAddress, TREASURY_MANAGER_ABI, "getYieldValueUSDC");
  const totalSupply = callView(runtime3, runtime3.config.usdcgAddress, USDCG_ABI, "totalSupply");
  const totalBacking = usdcBuffer + yieldValue;
  const upperBPS = BigInt(runtime3.config.bufferUpperBPS);
  const lowerBPS = BigInt(runtime3.config.bufferLowerBPS);
  const targetBPS = BigInt(runtime3.config.bufferTargetBPS);
  let action = "hold";
  let actionAmount = 0n;
  ...
  runtime3.log(`Buffer: ${formatUnits(usdcBuffer, 6)} USDC (${bufferRatioBPS} BPS) | Yield: ${formatUnits(yieldValue, 6)} | Action: ${action} ${formatUnits(actionAmount, 6)}`);
  ...
  runtime3.log(`Rebalance attestation: ${result.txHash}`);
