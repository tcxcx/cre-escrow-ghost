    ...
    return (
      <div className="grid grid-cols-4 gap-1.5 px-3 pb-2">
        {Array.from({ length: 4 }).map((_, i) => (
          <div key={i} className="rounded-lg border border-borderFine bg-card/60 px-2 py-2 space-y-1">
  ...
  return (
    <div className="px-3 pb-2 space-y-1.5">
      ...
      <div className="grid grid-cols-4 gap-1.5">
        {MINI_STATS.map((s) => {
          ...
          return (
            <div
              key={s.key}
              className="rounded-lg border border-borderFine bg-card/60 px-2 py-2 space-y-0.5"
            >
      ...
      {stats.totalValueLocked > 0 && (
        <div className="flex items-center justify-between rounded-lg border border-borderFine bg-card/60 px-2.5 py-1.5">
