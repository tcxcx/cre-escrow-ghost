...
contract FHERC20Wrapper is FHERC20, Ownable, FHERC20UnwrapClaim {
    ...
    function wrap(address to, uint64 value) public virtual {
    ...
    function unwrap(address to, uint64 value) public virtual {
        if (to == address(0)) to = msg.sender;
     ...
     */
    function claimUnwrapped(bytes32 ctHash) public virtual {
     ...
     */
    function claimAllUnwrapped() public virtual {
